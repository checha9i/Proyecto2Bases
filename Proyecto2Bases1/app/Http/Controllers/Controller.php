...
class Controller extends BaseController
{
  ...
  public function AnadirActividad(Request $req)
  {
    ...
    $noproceso=DB::table('gestion')->max('idgestion');
    DB::statement('call sp_CrearGestion(:idp,:idg)',['idp'=>$proceso,'idg'=>$noproceso]);
  ...
  {
    Session::put('gestionamostar',$id);

    return redirect("/Notificacion");
  }

  public function detalleetapacondicion1(Request $req)
  {
$condicion=$req->input('condicion');
    DB::statement('call sp_atendernotificacion(:idu,:idp,:ide,:idg,:res)',['idu'=>Session::get('User'),'idp'=>Session::get('procesonotificacion'),'ide'=>Session::get('numeroetapa'),'idg'=>Session::get('gestionamostar'),'res'=>$condicion]);
    return redirect('/Usuarios');
  }
