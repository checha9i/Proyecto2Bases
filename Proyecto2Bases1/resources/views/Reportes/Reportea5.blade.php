...
$result=DB::select('
select  f.idflujo, p.idproceso
	from copiaflujo f, proceso p
		where f.idestado=3 and f.idproceso= p.idproceso and p.fecha_creacion <= :par1 and p.fecha_creacion >= :par2
        	order by f.idflujo;
  ',['par1'=>Session::get('par3'),'par2'=>Session::get('par4')]);
?>
