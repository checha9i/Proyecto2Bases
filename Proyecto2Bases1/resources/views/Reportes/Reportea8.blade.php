...
$result=DB::select('select distinct(d.iddocumento), a.idactivdiad,  f.idestado
	from  copiaflujo f, etapa e, proceso p,estado es, gestion g, actividad a, documento d, detalle_proceso_departamento dp, departamento dep
		where f.idproceso = p.idproceso and g.idactivdiad = a.idactivdiad and g.iddocumento=d.iddocumento
			and dp.idproceso=:par1 and dp.iddepartamento=:par2
