    ...
    <div  id="contenido" name="contenido" class="content mt-3">
              ...
              <form action="/consulta5" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text"  class="form-control" name="Valor" value="Valor yyyy-mm-dd" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Valor';}" >
                </div>
                <div class="form-group">

                  <input type="text"  class="form-control" name="Valor2" value="Valor yyyy-mm-dd" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Valor';}" >
                </div>
                <div class="form-group">
                  <div class="submit">
